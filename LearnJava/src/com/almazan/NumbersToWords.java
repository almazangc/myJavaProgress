...
The logic above is correct, but in its current state,
the words will be printed in reverse order. For example,
...
but the method numberToWords should print "One Zero Zero". To get the number of zeroes,
