...
These methods should be named addHamburgerAddition1, addHamburgerAddition2, addHamburgerAddition3, addHamburgerAddition4, and itemize hamburger.
...
public class Main {
    public static void main(String[] args) {
        ...
        HealthyBurger healthyBurger = new HealthyBurger("Bacon", 5.67);
        healthyBurger.addHealthyAddition2("Egg", 5.43);
        healthyBurger.addHealthyAddition2("Drinks", 1.50);
        healthyBurger.addHealthyAddition1("Lentils", 3.41);
        System.out.println("Total Healthy Burger price is  " + healthyBurger.itemizeHamburger());
        System.out.println();

        DeluxeBurger deluxe = new DeluxeBurger();
        deluxe.addHamburgerAddition3("Should not do this", 50.53);
        System.out.printf("%s %.2f","Total Deluxe Burger price is ", deluxe.itemizeHamburger());
